...
-- AddForeignKey
ALTER TABLE "deliveries_logs" ADD CONSTRAINT "deliveries_logs_delivery_id_fkey" FOREIGN KEY ("delivery_id") REFERENCES "deliveries"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
